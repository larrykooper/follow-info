class Hash
  ...
  #
  # @param list [Integer, String, Twitcon::List] A Twitter list ID, slug, or object.
  # @return [Hash]
  def merge_list!(list)
    case list
    when Integer
  ...
  #
  # @param user[Integer, String, Twitcon::User] A Twitter user ID, screen_name, or object.
  # @return [Hash]
  ...
  #
  # @param users [Array<Integer, String, Twitcon::User>, Set<Integer, String, Twitcon::User>] An array of Twitter user IDs, screen_names, or objects.
  # @return [Hash]
